<?php include_once 'includes/header.php';include_once 'includes/dbconnect.php'; ?>
      ...
      <?php  }
		...
		<?php }
          ...
          if ($insert) {?>
           <div class=" alert btn-warning alert-error ">
            <a href="login2.php?" class="close " data-dismiss="alert">&times;</a>
      ...
      ?>
				...
				<form  action="registration_form2.php" class="form-horizontal" class="Jumbotron" method="POST">
          ...
          &nbsp;
			   ...
			   <a href="login2.php" class="pull-right glyphicon glyphicon-menu-right"><i>Back!</i></a>
