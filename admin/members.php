...
function show(id)
{
	...
	{
		//alert(id+" is deleted .");
		window.location.replace("member_delete.php?id="+id);
	}
	else
	{
 ...
 <div class="col-md-10">
   <h2 ><center>Members</center></h2><hr>
...
while ($row=mysqli_fetch_assoc($query)) {?>
	...
	<td><a href="member_view.php?id=<?php echo $row['id']; ?>"><center>view</center></a></td>
	<td><a href="" onclick="show('<?php echo $row["id"]; ?>')">Delete</a></td>
</tr>	<?php
}
?>
</table>
