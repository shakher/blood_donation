...
function show(id)
{
	...
	{
		//alert(id+" is deleted .");
		window.location.replace("d_delete.php?id="+id);
	}
	else
	{
...
while ($row=mysqli_fetch_assoc($query)) {?>
	...
	<td><a href="d_view.php?id=<?php echo $row['Donor_id']; ?>"><center>view</center></a></td>
	<td><a href="" onclick="show('<?php echo $row["Donor_id"]; ?>')">Delete</a></td>
</tr>	<?php
}
?>
</table>
