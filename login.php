...
<?php include_once 'includes/header.php';include_once 'includes/dbconnect.php'; ?>
      ...
      ?>
          <a href="update_login.php" class="pull-right glyphicon glyphicon-menu-right"><i>update!</i></a>
			  ...
			  <form  action="login.php" class="form-horizontal" class="Jumbotron" method="POST">
          ...
          &nbsp;
            ...
            <a href="registration_form.php" class="pull-right glyphicon glyphicon-menu-right"><i>Registration!</i></a>
